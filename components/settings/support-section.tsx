...
const FAQ_ITEMS = [
  {
    q: "ソシオとは何ですか？",
    a: "ソシオとは、SPOT（お気に入りの場所・コミュニティ）を月額で応援するサポーターのことです。加入すると、そのSPOTの限定お知らせやイベントを閲覧できるようになります。"
  },
  {
    q: "支払い方法を教えてください。",
    a: "クレジットカード・デビットカードによる月額自動引き落としです。決済は Stripe を通じて安全に処理されます。カード情報は SPOT のサーバーには保存されません。"
  },
  {
    q: "解約はどうすればできますか？",
    a: "設定内の「メンバーシップ管理」から解約手続きができます。解約後も当月末まではメンバーエリアへのアクセスが継続されます。"
  },
  {
    q: "メールリンクが届きません。",
  ...
  {
    q: "運営者として SPOT を登録するにはどうすればよいですか？",
    a: "ヘッダーの「運営中のSPOT」または「SPOTを作る」から登録できます。Stripe との受取設定を完了すると、ソシオの受け付けを開始できます。"
  }
] as const;

...
const FAQ_ITEMS = [
  {
    q: "応援会員とは何ですか？",
    a: "応援会員とは、街の文化拠点（本屋・ミニシアター・ライブハウスなど）を1口100円から支えられる会員制度です。加入すると番号入りの会員証を持ち、店からの限定投稿を受け取れます。口数に関わらず、応援会員の基本的な権利は全員同じです。"
  },
  {
    q: "支払い方法を教えてください。",
    a: "クレジットカード・デビットカード・Apple Pay・Google Pay・PayPayによる月額自動引き落としです。決済は外部の決済代行サービスを通じて安全に処理され、カード情報は SPOT のサーバーには保存されません。"
  },
  {
    q: "解約はどうすればできますか？",

...
const FAQ_ITEMS = [
  {
    q: "サポーターとは何ですか？",
    a: "サポーターとは、SPOT（組織・団体・プロジェクトのための小さなファンクラブ）に月100〜500円で参加できる新しい応援のかたちです。加入すると限定のお知らせ・イベント・アンケートなどに参加できるようになります。金額に関わらず、すべてのサポーターが1票を持ちます。"
  },
  {
    q: "支払い方法を教えてください。",
  ...
  {
    q: "解約はどうすればできますか？",
    a: "設定内の「サポーターシップ管理」から「支払い・解約を管理」ボタンを押して手続きできます。解約後は次回更新日まで引き続き利用できます。月途中の日割り返金はありません。"
  },
  {
    q: "メールリンクが届きません。",
  ...
  },
  {
    ...
    a: "ヘッダーメニューの「SPOTを作る」から登録できます。登録は無料で、受取設定を完了するとサポーター募集を開始できます。"
  }
] as const;

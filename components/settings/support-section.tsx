...
const FAQ_ITEMS = [
  {
    q: "ソシオとは何ですか？",
    a: "ソシオとは、SPOT（お気に入りの場所・コミュニティ）に月100円から参加できる新しい応援のかたちです。加入すると限定のお知らせ・イベント・アンケートなどに参加できるようになります。金額に関わらず、すべてのソシオが1票を持ちます。"
  },
  {
    q: "支払い方法を教えてください。",
  ...
  },
  {
    ...
    a: "ヘッダーメニューの「SPOTを作る」から登録できます。登録は無料で、受取設定を完了するとソシオ募集を開始できます。"
  }
] as const;

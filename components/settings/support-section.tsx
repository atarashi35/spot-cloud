...
const FAQ_ITEMS = [
  {
    q: "応援会員とは何ですか？",
    a: "応援会員とは、街の文化拠点（本屋・ミニシアター・ライブハウスなど）を年会費¥3,000から支えられる会員制度です。加入すると番号入りの会員証を持ち、店からの限定投稿を受け取れます。コースに関わらず、応援会員の基本的な権利は全員同じです。"
  },
  {
    q: "支払い方法を教えてください。",
    a: "クレジットカード・デビットカード・Apple Pay・Google Pay・PayPayによる年額自動引き落としです。決済は外部の決済代行サービスを通じて安全に処理され、カード情報は SPOT のサーバーには保存されません。"
  },
  {
    q: "解約はどうすればできますか？",
    a: "設定内の「応援会員シップ管理」から「支払い・解約を管理」ボタンを押して手続きできます。解約後は次回更新日まで引き続き利用できます。契約期間途中の日割り返金はありません。"
  },
  {
    q: "メールリンクが届きません。",

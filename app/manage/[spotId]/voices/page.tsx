  ...
  return (
    <PageShell className="space-y-6 py-8">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-ink">アンケート</h1>
        {user && (
              ...
              <div key={vote.id} className="px-6 py-5">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex shrink-0 items-center gap-2">
                    {vote.status === "open" && (
                      <button type="button" onClick={() => void handleClose(vote.id)} className="text-xs font-semibold text-ink/40 hover:text-ink/70">
                        締め切る
                      </button>
                    )}
                    ...
                    <button type="button" onClick={() => void handleDelete(vote.id)} className="rounded-full p-1.5 text-ink/30 transition hover:bg-red-50 hover:text-red-400">

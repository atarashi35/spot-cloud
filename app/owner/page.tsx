...
const values = [
  ...
  },
  {
    eyebrow: "続けられる",
    title: "関係を\n継続できます。",
    body: "イベントや投稿で定期的につながり、サポーターとの距離を縮め続けられます。",
  },
];
...
const comparison = [
  { axis: "かたち", cf: "一度きりの資金集め", spot: "毎月続くファンクラブ" },
  { axis: "目的", cf: "目標額を達成する", spot: "続く関係をつくる" },
  { axis: "終わり方", cf: "達成したら終了", spot: "ずっと続いていく" },
  { axis: "関係", cf: "支援したら終わり", spot: "投稿・投票で関わり続ける" },
];
...
const faqs: { q: string; a: React.ReactNode }[] = [
  ...
  {
    q: "個人でも利用できますか？",
    a: "はい。アーティスト、クリエイター、演奏家など個人で活動している方も利用できます。",
  },
  {
    q: "サポーターと何ができますか？",

...
const values = [
  ...
  },
  {
    eyebrow: "一緒につくる",
    title: "参加者と\n活動を育てられます。",
    body: "アンケートや意見募集を通して、ソシオの声を活動に活かせます。",
  },
  {
    eyebrow: "続けられる",
    title: "関係を\n継続できます。",
    body: "イベントやお知らせで定期的につながり、ソシオとの距離を縮め続けられます。",
  },
];
...
const steps = [
  ...
  {
    title: "受取設定を行う",
    body: "受取口座の設定です。完了後、ソシオ募集を本番公開できます。",
  },
  {
    title: "ソシオを募集する",
...
const faqs: { q: string; a: React.ReactNode }[] = [
  {
    ...
    a: (
      <span>
        SPOTの登録・公開は無料です。ソシオから支援を受けた場合のみ、
  ...
  {
    q: "ソシオの月額金額は？",
    a: "月100円・300円・500円の3プランです。どのプランでも、ソシオは1票を持ちます。",
  },
  {
    q: "どんな団体が利用できますか？",
    ...
    <div className="pb-20">
      ...
      <PageShell>
        <div className="mb-8 text-center">
          ...
          <h2 className="mt-3 text-2xl font-bold text-ink sm:text-3xl">ソシオと共に育てる、3つのこと。</h2>
        </div>
      ...
      <PageShell className="mt-14">
        <div className="overflow-hidden rounded-[28px] border border-ink/8 bg-white px-8 py-10 sm:px-10 sm:py-12">
          ...
          <p className="mt-4 text-xs leading-6 text-ink/40">
            手数料はソシオの決済が発生した場合のみ。固定費・月額費用はかかりません。
          </p>

          {/* 振込額 */}
          <div className="mt-8 border-t border-ink/8 pt-7">
            <p className="text-sm font-semibold text-ink">ソシオ1人あたりの振込額（目安）</p>
        ...
        <div className="relative overflow-hidden rounded-[28px] bg-ink px-8 py-10 text-center sm:px-12 sm:py-14">
          ...
          <div className="relative">
            ...
            <p className="mt-4 text-sm leading-7 text-white/55">
              登録は無料。受取設定を完了すると、ソシオ募集を本番公開できます。
            </p>

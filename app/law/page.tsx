...
const items: { label: string; value: string }[] = [
  ...
  { label: "サービス名", value: "SPOT" },
  {
    label: "サービス内容",
    value:
      "応援会員型コミュニティプラットフォーム。SPOT（場所・コミュニティ）に年会費サブスクリプションで所属し、限定情報・イベントなどを受け取れるサービス。"
  },
  {
    label: "料金",
    value:
      "年会費¥3,000／¥5,000／¥10,000（税込）の3コース制。会員が選んだコースの金額を年1回お支払いいただきます。" +
      "2026年7月の改定前に月額プラン（1口100円の口数制）で加入した会員は、従前の月額プランのまま利用を継続できます。"
  },
  { label: "支払い方法", value: "クレジットカード（Visa・Mastercard・American Express・JCB）、Apple Pay、Google Pay、PayPay" },
  {
    label: "支払い時期",
    value: "加入手続き完了時に初回課金が発生し、以降は毎年同日に自動更新されます。"
  },
  { label: "役務の提供時期", value: "決済完了後、即時にご利用いただけます。" },
  {
    label: "返品・キャンセルについて",
    value:
      "契約期間途中の解約による日割り返金は行っておりません。解約後は次回更新日まで引き続き利用可能です。"
  },
  {
    label: "解約方法",
    value:

    ...
    <PageShell className="space-y-8">
      ...
      <Card className="px-6 py-8 sm:px-8">
        <div className="space-y-8 text-sm leading-7 text-ink/75">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">第1条（総則）</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">第2条（サービスの概要）</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">第3条（利用資格）</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">第4条（料金・支払い）</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">第5条（解約・返金）</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">第6条（禁止事項）</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">第7条（免責事項）</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">第8条（サービスの変更・停止）</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">第9条（規約の変更）</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">第10条（準拠法・裁判管轄）</h2>
            <p className="mt-3">
          ...
          <section className="rounded-[20px] bg-mist px-5 py-4">
            <p className="text-xs text-ink/55">お問い合わせ: spotcloud2026@gmail.com</p>
          </section>

    ...
    <div className="space-y-8 pb-20">
      ...
      <Card className="px-6 py-8 sm:px-8">
        <div className="space-y-8 text-sm leading-7 text-ink/75">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">1. 事業者</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">2. 収集する情報</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">5. 外部サービスの利用</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">6. 情報の管理</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink">7. 開示・訂正・削除</h2>
            <p className="mt-3">
